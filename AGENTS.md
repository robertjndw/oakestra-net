...
- **`resolver/`** — ServiceResolver: netlink-free packet-path resolution of Service IPs, Namespace IPs and Instance IPs against the translation table, kicking off background MQTT table queries on a miss; this is what lets `proxy` build and test without netlink
